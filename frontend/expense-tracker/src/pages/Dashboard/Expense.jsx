/**
 * Expense.jsx
 * Manages expense listing, creation, summary overview,
...
function Expense() {
  ...
  /**
   * Resets add-expense form fields.
   */
  const resetForm = () => {
    setFormData({
      category: '',
  ...
  const handleAddExpense = async (event) => {
    ...
    try {
      ...
      // Refresh expense list after adding
      await fetchExpenses();
  ...
  /**
   * Downloads expense report as an Excel file.
   */
  const handleDownloadExpense = async () => {
    try {
      ...
      console.error('Failed to download expense report:', error);
      setError('Could not download expense report.');
    }
  };

  /**
   * Memoized expense summary data.
   */
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Track your spending, download reports, and add new expenses.
            </p>
          </div>
          ...
          <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/30 backdrop-blur-sm">
            <div className="bg-white w-full max-w-xl rounded-2xl shadow-2xl border border-gray-200 p-6 relative">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Log a new expense to keep your overview up to date.
              </p>
